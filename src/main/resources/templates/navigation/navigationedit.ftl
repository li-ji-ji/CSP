		  ...
		  <div class="layui-field-box">
			<form class="layui-form " method="post"
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input type="radio" name="position" value="top" title="顶部" <#if navigation.position=='top'> checked </#if> >
						<input type="radio" name="position" value="bottom" title="底部" <#if navigation.position=='bottom'> checked </#if> >
					</div>
				</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input type="text" name="name" value="${navigation.name}" required
							lay-verify="required" id="name" autocomplete="off"
							class="layui-input">
					</div>
					<div class="layui-form-mid layui-word-aux" id="navName"
						style="color: red !important; display: none;">导航名称不能超过10个字符</div>
				</div>
