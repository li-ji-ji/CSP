...
<body class="layui-layout-body">
	...
	<fieldset class="layui-elem-field">
		  <legend>搜索关键词添加</legend>
		  <div class="layui-field-box">
			<form class="layui-form " method="post"
				action="/searchword/addSearchWord" style="margin-top: 50px;">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input type="text" name="pinyinFull" 
							 autocomplete="off"
							class="layui-input">
					</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input type="text" name="pinyinSimple"  
							 autocomplete="off"
							class="layui-input">
					</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input type="text" name="searchNum" value="0" 
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input type="text" name="goodsNum" value="0" 
							readonly autocomplete="off" class="layui-input">
					</div>
