...
<body>
    ...
    <div class="layui-btn-group demoTable">
        ...
        <button class="layui-btn" style="background: antiquewhite;">
            <a href="/authority/rolepermission/toedit">添加</a>
        </button>
    </div>

    <table class="layui-table" lay-data="{width: 1200, height:330, url:'/authority/rolepermission/all', page:true, id:'idTest'}"
        lay-filter="demo">
        <thead>
            <tr>
          ...
          //监听工具条
                ...
                if (obj.event === 'detail') {
                    ...
                    layer.confirm('真的删除行么', function (index) {
                        ...
                        xmlhttp
                            .open(
                                "get",
                                "/authority/rolepermission/delete?id="
                                + data.id,
                                true);
                        xmlhttp
                            .send();
                    ...
                    window.location.href = "/authority/rolepermission/toedit?id="
                        + data.id;
                }
            });
            ...
            var $ = layui.$, active = {
                ...
                , batchDelete: function () {//批量删除
                    ...
                    $.ajax({
                        url: "/authority/rolepermission/batchdelete", type: "post", dataType: "json", data: { "jsonStr": JSON.stringify(data) }, success: function (e) {
