...
<form class="layui-form" style="margin-top:50px;" action="" lay-filter="example">
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-input-block">
      <input type="number" name="id" placeholder="请输入菜单ID" autocomplete="off" class="layui-input">
    </div>
  </div>
  <div class="layui-form-item">
  ...
  <div class="layui-form-item">
    <label class="layui-form-label">父级菜单名称</label>
    <div class="layui-input-block">
      <input type="text" name="name" placeholder="请选择父级菜单名称" autocomplete="off" class="layui-input">
    </div>
  </div>
