package cn.lhj.csp.fileinfo.util;
...
import cn.lhj.csp.fileinfo.util.WXPayConstants.SignType;
...
public class WXPayUtil {
	...
	public static String TransferRestTemplate(String url, String data) throws KeyStoreException, IOException,
		...
		ClassPathResource resource = new ClassPathResource("static\\spring\\apiclient_cert.p12");
		InputStream instream = resource.getInputStream();
		//InputStream instream = new FileInputStream("src\\main\\resources\\static\\spring\\apiclient_cert.p12");
