package cn.lhj.csp.assomanagement.feign;
...
import cn.lhj.csp.assomanagement.po.student.Student;
import cn.lhj.csp.assomanagement.po.student.SysPermission;
import cn.lhj.csp.assomanagement.po.student.SysRole;
import cn.lhj.csp.assomanagement.po.student.SysRolePermission;
import cn.lhj.csp.assomanagement.po.student.SysStudentRole;
...
public interface StudentRemote {
	 ...
	 * 学生表
	 */
	@RequestMapping("/bg/studentapi/getStudentBySn")
	public Student getStudentBySn(@RequestParam("sn")String sn);
