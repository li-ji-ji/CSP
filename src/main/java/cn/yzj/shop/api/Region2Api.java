...
public class Region2Api {
		...
		public Msg insert(@RequestBody Region2 region) {
			return region2Service.add((Serializable) region);
		}
		...
		public Msg update(@RequestBody Region2 region) {
			return region2Service.updata((Serializable) region);
		}
		
		@RequestMapping("/api/region2/findByPid")
		public Serializable findByPid(@RequestParam("pid")Integer pid) {
			return region2Service.find(pid);
		}
}
