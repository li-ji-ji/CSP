...
Page({
  ...
  getTaskList: function () {
    ...
    for (var i = that.data.start; i < that.data.long; i++) {
      var task = { time: "", school: "", status: 0, title: "", express: [], remarks: "", taskReward: "", taskId: 0, taskPublisher: "", taskType: 0, taskContext: "", images:""};
    ...
    wx.getNetworkType({
      success: function(res) {
        if (res.networkType=="none"){
          ...
          wx: wx.request({
            url: 'http://244z00029g.zicp.vip/displayTaskAll',
            data: {
              "status": 0
            },
            header: {
